...
export declare type MiniMapNodeFunc = (node: GraphNode) => string
declare type MiniMapNodeFunc2 = (node: GraphNode) => string
declare type MiniMapNodeFunc3 = (node: GraphNode) => string
export declare type ShapeRendering = CSSProperties['shapeRendering']
